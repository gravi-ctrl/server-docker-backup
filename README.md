...
For restoration instructions including secrets, refer to **[Phase 2: Restore Docker Stacks](https://github.com/gravi-ctrl/server-scripts/tree/main#phase-2-restore-docker-stacks) in [server-scripts repo](https://github.com/gravi-ctrl/server-scripts/)**
